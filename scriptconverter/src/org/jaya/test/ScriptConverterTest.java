...
public class ScriptConverterTest {
	...
	{
		ScriptConverter dev2it = ScriptConverterFactory.getScriptConverter(ScriptConverter.DEVANAGARI_SCRIPT, ScriptConverter.ITRANS_SCRIPT);
		ScriptConverter it2dev = ScriptConverterFactory.getScriptConverter(ScriptConverter.ITRANS_SCRIPT, ScriptConverter.DEVANAGARI_SCRIPT);
		
		String[] inputs = new String[]{
				"bRhaddhaatukOSa",
				"nArAyaNaM guNaiH sarvairudIrNaM dOShavarjitam",
				"jnEyaM gamyaM gurUMshcaapi natvaa sUtraartha uchyatE"
				};
		String input;
