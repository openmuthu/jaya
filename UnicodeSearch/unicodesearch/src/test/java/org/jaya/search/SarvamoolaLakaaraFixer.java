...
public class SarvamoolaLakaaraFixer {
	...
	public static void convertFilesToUTF16LE(String dir){
		...
		for (File file : fileList) {			
			try{
				String filePath = f1.getCanonicalPath();
				String newFilePath = f1.getParent() + File.separator + FilenameUtils.getBaseName(filePath) + "_fixed." + FilenameUtils.getExtension(filePath);
